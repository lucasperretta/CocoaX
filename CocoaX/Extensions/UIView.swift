...
extension UIView {
     ...
     */
    func addShadowBehavior(button: UIButton) {
     ...
     */
    func applyGradient(firstColor: UIColor, secondColor: UIColor, orientation: GradientOrientation) {
     ...
     */
    func applyShadow(color: UIColor? = UIColor.black, opacity: Float? = 0.4, radius: CGFloat? = 6, offset: CGSize? = CGSize(width: 0, height: 0)) {
     ...
     */
    func applyDefaultShadow(style: DefaultShadow = .normal) {
        let radius: CGFloat
        switch style {
        case .ultraThin:
            radius = 2
     ...
     */
    func applyRadiusWithAnimation(duration: CFTimeInterval, radius: CGFloat) {
     ...
     */
    func applyShadowRadiusWithAnimation(duration: CFTimeInterval, radius: CGFloat) {
